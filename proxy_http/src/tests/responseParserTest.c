...
static void
assertCompleteResponseWithChunkAndZeros (ResponseData *rData, buffer *b, buffer *bOut, buffer *bTransf);
static void
...
static void
assertIncompleteResponseWithLengthByByteAndZeros (ResponseData *rData, buffer *b, buffer *bOut, buffer *bTransf);
static void
assertIncompleteResponseWithChunkByByte (ResponseData *rData, buffer *b, buffer *bOut, buffer *bTransf);
static void
assertIncompleteResponseWithChunkByByteAndZeros (ResponseData *rData, buffer *b, buffer *bOut, buffer *bTransf);
static void
...
static void
insertToBufferWithZeros (ResponseData *rData, char *text, buffer *b, buffer *bOut);
static void
