...
unsigned char* serialize_string(unsigned char* buffer, unsigned char* str);
unsigned char* serialize_msg(unsigned char* buffer, msg_t* msg);
...
unsigned char* deserialize_string(unsigned char* buffer, unsigned char* str);
unsigned char* deserialize_msg(unsigned char* buffer, msg_t* msg);
